...
const getPublication = (async() =>{
  ...
  var data = await getapi(BASE_URL+"/author/findAuthorById/"+authorId);
    ...
    document.getElementById("publish-date").value = data.response.publistionDate;
});
...
function addSubscription(){
    ...
    const subscriptionfees = document.getElementById("subscription-fees").value;
    ...
    let url = BASE_URL+"/book/addSubscriptionBook";
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4) {
        ...
        if (objects['status'] == '200') {
          ...
          Swal.fire({
            text: 'Book Subscription added successfully',
            icon: 'success',
